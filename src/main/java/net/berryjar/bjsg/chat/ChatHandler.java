package net.berryjar.bjsg.chat;

import org.bukkit.ChatColor;

public class ChatHandler {

    public static String chatPrefix = ChatColor.DARK_PURPLE + "[" + ChatColor.DARK_AQUA + "Survival Games" + ChatColor.DARK_PURPLE + "] " + ChatColor.RESET;
